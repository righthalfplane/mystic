...
#define NoCommand					0
#define QuitProgram					1
#define FileItemCommand				2
#define GetDataCommand				3
#define GetLineDataCommand			4
#define GetAreaDataCommand			5
#define GetSDS3DDataCommand			6
#define GetStreamDataCommand		7
#define GetDataCommand2D			8
#define GetAreaDataCommand2D		9
#define GetLineDataCommand2D	   10
