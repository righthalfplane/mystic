...
int main()
{
	...
	if(Translate("manhattan.stl"))goto ErrorOut;
...
/*	    
	    ...
	    if(ret)goto ErrorOut;
*/
        ret=showElements(show,ne,3L,elem4);
	    if(ret)goto ErrorOut;
