...
Cylinder(1) = {0.0, 0.0, 0.0, 0, 0, 82, 7.5, 2*Pi};
...
Cylinder(2) = {0.0, 0.0, 62., 0, 0, 30, 4.42, 2*Pi};
...
Cylinder(7) = {-15.0, 0.0, 66.5,   30, 0.0, 0, 2.2, 2*Pi};

BooleanDifference(8)={Volume{5}; Delete;}{Volume{6};Volume{7}; Delete;};

Cylinder(9) = {0.0, 0.0, 14.0, 0, 0, 3, 9.7, 2*Pi};

Cylinder(10) = {0.0, 0.0, 52.0, 0, 0, 3, 9.7, 2*Pi};

Box(12) = {7.5,-1.0,0.0,    3,2,82};

Box(14) = {7.5,-1.0,0.0,    3,2,82};
