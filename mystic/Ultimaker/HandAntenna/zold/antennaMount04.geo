...
Cylinder(2) = {0.0, 0.0, 40., 0, 0, 20, 5.15, 2*Pi};

BooleanDifference(3)={Volume{1}; Delete;}{Volume{2}; Delete;};

Cylinder(4) = {0.0, 0.0, 0.0, 0, 0, 20.0, 3.2, 2*Pi};

BooleanDifference(5)={Volume{3}; Delete;}{Volume{4}; Delete;};

//Cylinder(6) = {-15.0, 0.0, 10.0,   30, 0.0, 0, 1.06, 2*Pi};

//Cylinder(7) = {-15.0, 0.0, 68.5,   30, 0.0, 0, 2.2, 2*Pi};
