...
Cylinder(4) = {0.0, 0.0, 10.0, 0, 0, 8.35, r, 2*Pi};

BooleanDifference(5)={Volume{1}; Delete;}{Volume{4}; Delete;};

Cylinder(6) = {-15.0, 0.0, 15.0,   30, 0.0, 0, r1, 2*Pi};

BooleanDifference(8)={Volume{5}; Delete;}{Volume{6}; Delete;};

Cylinder(7) = {0.0,0.0,0.0,   0,0,10.0, r3, 2*Pi};

BooleanDifference(9)={Volume{8}; Delete;}{Volume{7}; Delete;};
