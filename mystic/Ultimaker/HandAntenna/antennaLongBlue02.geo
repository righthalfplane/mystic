...
z()=Translate {-8.0, 0.0, 81.5} { Volume{30}; };

Cylinder(1) = {0.0, 0.0, 0.0, 0, 0, 95, 7.5, 2*Pi};

Cylinder(2) = {0.0, 0.0, 75., 0, 0, 30, 5.3, 2*Pi};
...
Cylinder(7) = {-15.0, 0.0, 81.5,   30, 0.0, 0, r2, 2*Pi};

BooleanDifference(8)={Volume{5}; Delete;}{Volume{6};Volume{7}; Delete;};

Cylinder(9) = {0.0, 0.0, 14.0, 0, 0, 3, 10, 2*Pi};

Cylinder(10) = {0.0, 0.0, 65.0, 0, 0, 3, 10, 2*Pi};
