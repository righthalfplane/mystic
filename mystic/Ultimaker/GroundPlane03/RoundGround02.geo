...
Cylinder(4) = {l3,0,r4+3, l3,0,-l3, r4, 2*Pi};

Cylinder(5) = {0,l2,r4+3, 0,l2,-l3, r4, 2*Pi};

Cylinder(6) = {0,-l2,r4+3, 0,-l2,-l3, r4, 2*Pi};

Cylinder(7) = {-l2,0,r4+3, -l2,0,-l3, r4, 2*Pi};

//Box(19) = {l2-r42,l2-r42,r4+3, l2+2*r42,l2+2*r42,-l3};

BooleanUnion(8)={ Volume{19};  Delete; }{Volume{4,5,6,7};  Delete;};

Cylinder(9) = {l2,0,r4+3, l2,0,-l3, r3, 2*Pi};

Cylinder(10) = {0,l2,r4+3, 0,l2,-l3, r3, 2*Pi};

Cylinder(11) = {0,-l2,r4+3, 0,-l2,-l3, r3, 2*Pi};

Cylinder(12) = {-l2,0,r4+3, -l2,0.,-l3, r3, 2*Pi};
