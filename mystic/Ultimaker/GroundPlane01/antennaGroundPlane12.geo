...
Cylinder(2) = {0.0, 0.0,  -4.0, 0, 0, 54, r3, 2*Pi};

//BooleanDifference(3)={Volume{1}; Delete;}{Volume{2}; Delete;};

Cylinder(4) = {-l2, 0.0, -3.0,  l2,0,l2, r4, 2*Pi};

Cylinder(5) = {l2, 0.0, -3.0,  -l2,0,l2, r4, 2*Pi};

Cylinder(6) = {0.0, -l2, -3.0,  0.0,l2,l2, r4, 2*Pi};

Cylinder(7) = { 0.0, l2, -3.0,  0.0,-l2,l2, r4, 2*Pi};
