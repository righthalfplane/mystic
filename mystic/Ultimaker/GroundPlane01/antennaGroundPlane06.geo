...
Cylinder(1) = {0.0, 0.0, 0.0, 0, 0, 34, 7.5, 2*Pi};
...
Cylinder(14) = {-l2, 0.0, -3.0, l, 0,    l, 3.175, 2*Pi};

Cylinder(15) = {l2, 0.0, -3.0, -l, 0,    l, 3.175, 2*Pi};

Cylinder(16) = {0.0, -l2, -3.0, 0.0, l,  l, 3.175, 2*Pi};

Cylinder(17) = { 0.0, l2, -3.0, 0.0,-l,  l, 3.175, 2*Pi};
...
Cylinder(22) = {-13.0,  -10.0, 7.0,   0, 16.0, 0,r, 2*Pi};

BooleanDifference(23)={Volume{21}; Delete;}{ Volume{22}; Delete;};

Cylinder(24) = {-10.0,  -13.0, 7.0,   16.0, 0.0, 0,r, 2*Pi};

BooleanDifference(25)={Volume{23}; Delete;}{ Volume{24}; Delete;};

Cylinder(26) = {-10.0,  13.0, 7.0,   16.0, 0.0, 0,r, 2*Pi};

BooleanDifference(27)={Volume{25}; Delete;}{ Volume{26}; Delete;};

Cylinder(28) = {13.0,  -10.0, 7.0,   0, 16.0, 0,r, 2*Pi};
