...
Cylinder(4) = {-20.0, 0.0, 0.0, 20, 0, 20*r2, 5.175, 2*Pi};

Cylinder(5) = {20.0, 0.0, 0.0, -20, 0, 20*r2, 5.175, 2*Pi};

Cylinder(6) = {0.0, -20.0, 0.0, 0.0, 20, 20*r2, 5.175, 2*Pi};

Cylinder(7) = { 0.0, 20.0, 0.0, 0.0,-20, 20*r2, 5.175, 2*Pi};

BooleanUnion(8)={ Volume{1};  Delete; }{Volume{4,5,6,7};  Delete;};

BooleanDifference(9)={Volume{8}; Delete;}{ Volume{2}; Delete;};

Cylinder(14) = {-20.001, 0.0, 0.0, l/r2, 0,    l, 3.175, 2*Pi};

Cylinder(15) = {20.001, 0.0, 0.0, -l/r2, 0,    l, 3.175, 2*Pi};

Cylinder(16) = {0.0, -20.001, 0.0, 0.0, l/r2,  l, 3.175, 2*Pi};

Cylinder(17) = { 0.0, 20.001, 0.0, 0.0,-l/r2,  l, 3.175, 2*Pi};
